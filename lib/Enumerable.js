(function(exports){
	...
	Enumerable.prototype.Where = function(condition){
		var self = this;
		return new Where(self.sequence,condition);
	};

	Enumerable.prototype.Select = function(selector){
		var self = this;
		return new Select(self.sequence,selector);
	};

	Enumerable.prototype.First = function(selector){
		var self = this;
		return new First(self.sequence,selector);
	};

	Enumerable.prototype.Any = function(condition){
		var self = this;
		return new Any(self.sequence,condition);
	};

	Enumerable.prototype.Count = function(condition){
		var self = this;
		return new Count(self.sequence);
	};

	Enumerable.prototype.ToArray = function(){
		var self = this;
		return new ToArray(self.sequence);
	};
